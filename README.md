...
- [kokoro-onnx](https://github.com/thewh1teagle/kokoro-onnx.git) 🤗
...
For Mac users, use the `requirements_mac.txt` file instead( not supported ATM):

```bash
uv pip install -r requirements_mac.txt
```

In order to use Kokoro TTS, you also need to run:
...
```bibtex
@misc{thewh1teagle-2025-kokoro-onnx,
  author = {thewh1teagle},
  title = {kokoro-onnx},
  year = {2025},
  publisher = {GitHub},
  journal = {GitHub repository},
  howpublished = {\url{https://github.com/thewh1teagle/kokoro-onnx}}
}
```
